...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    buyLinks: Schema.Attribute.JSON;
    coverImage: Schema.Attribute.Media<'images' | 'files'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    edition: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    ...
    > &
      Schema.Attribute.DefaultTo<'Non-fiction'>;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    availability: Schema.Attribute.Enumeration<
      ['open', 'limited seats', 'sold out']
    > &
      Schema.Attribute.DefaultTo<'open'>;
    bannerImage: Schema.Attribute.Media<'images'>;
    city: Schema.Attribute.String;
    country: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Nigeria'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    largeText: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
